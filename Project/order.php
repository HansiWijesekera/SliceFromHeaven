                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="order.php" method="post" id="formoid">
    ...
    <div class="col-lg-4">
        <div1 class="login-box animated fadeInUp mt-5 light-box-width items-table-content">
            ...
            <table style="width:100%" class="table table-hover">
                ...
                <tr><td><div>	<button type="submit" ><a class="acti" href="query.php" >Confirm Order</button><br><br>
                    <button type="submit" ><a class="acti" href="dev1.php" >Discard Order</button></div></td></tr>
...
<br><br> 
    ...
    <script>
      ...
      <br/>
      <div ><button type="submit" ><a class="acti" href="dev.php">Submit Payment</button>
      </div>
